...
import com.axellience.vuegwt.gwt2.template.parser.exceptions.TemplateParserException;
    ...
    implements SupportsGeneratorResultCaching
{
    ...
    throws UnableToCompleteException
    {
        ...
        String templateResourceTypeName =
            getTypeName(method) + GenerationNameUtil.COMPONENT_JS_TYPE_SUFFIX;
     ...
     * @param templateResourceTypeName The name of our Template resource generated by
    ...
    private void processComponentStyles(SourceWriter sw, TemplateParserResult templateParserResult)
    {
        ...
        {
            String styleInstance = GenerationNameUtil.styleBundleName(entry.getValue())
                + ".INSTANCE."
                + GenerationNameUtil.STYLE_BUNDLE_METHOD_NAME
                + "()";
