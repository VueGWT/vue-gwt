...
{
    public void bind(Element el, VNodeDirective binding) {
        // Do nothing, override to add behavior
    }
    public void inserted(Element el, VNodeDirective binding) {
        // Do nothing, override to add behavior
    }
    public void update(Element el, VNodeDirective binding) {
        // Do nothing, override to add behavior
    }
    public void componentUpdated(Element el, VNodeDirective binding) {
        // Do nothing, override to add behavior
    }
    public void unbind(Element el, VNodeDirective binding) {
        // Do nothing, override to add behavior
    }
}
