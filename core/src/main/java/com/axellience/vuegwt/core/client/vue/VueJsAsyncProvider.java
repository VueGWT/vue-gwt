 ...
 * VueJsConstructor}. Using this async mechanism allows us to have cylces in component definitions
 * (which is supported by Vue.js) even when injecting the dependencies with Gin.
 *
 * @author Adrien Baron
 */
@JsFunction
