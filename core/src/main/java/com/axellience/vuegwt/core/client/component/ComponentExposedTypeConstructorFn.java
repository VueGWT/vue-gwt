...
public interface ComponentExposedTypeConstructorFn<T extends IsVueComponent> {
   ...
   * is provided by Vue and doesn't extend the {@link IsVueComponent} constructor. This method will
   * create an instance of the ExposedType and copy properties to the VueComponentInstance. This
   * will initialise properties that are initialised inline in the class. For example:
