...
public class VueGWT {
  ...
  /**
   * Create a {@link Vue} instance for the given Vue Component Class. You can then call $mount on it
   ...
   */
  @JsIgnore
  public static <T extends IsVueComponent> VueComponentFactory<T> getVueComponentFactory(
  ...
  /**
   * Return the {@link VueComponentFactory} for the given {@link IsVueComponent} fully qualified
   * name.
   *
  ...
  /**
   * Return the Java Constructor of our {@link IsVueComponent} Java Class. This Constructor can be
   * used to get the prototype of our Java Class and get the VueComponent methods from it.
   *
  ...
  /**
   * Return the Java Constructor of our {@link IsVueComponent} ExposedType Java Class. This
   * Constructor can be used to get the prototype of our Java Class and get the VueComponent methods
   * from it.
   *
   * @param componentQualifiedName The fully qualified name of the {@link IsVueComponent} class
   * @param <T> The type of the {@link IsVueComponent}
