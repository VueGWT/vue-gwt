...
describe('Slot Scope', () => {
  ...
  [['when using v-slot', 'SlotScopeParentComponent'],
    ['when using the old slot syntax', 'SlotScopeParentOldComponent']].forEach(
        ...
        describe(description, () => {
          beforeEach(async () => {
            ...
            component = createAndMountComponent(
                `com.axellience.vuegwt.testsapp.client.components.slots.${componentName}`);
          });
