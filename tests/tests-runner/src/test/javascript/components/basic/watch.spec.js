  ...
  describe('Watch Data', () => {
    ...
    beforeEach(async () => {
      ...
      component = createAndMountComponent(
          'com.axellience.vuegwt.testsapp.client.components.basic.watch.data.WatchDataTestComponent');
    });
  ...
  describe('Watch Prop', () => {
    ...
    beforeEach(async () => {
      ...
      parentComponent = createAndMountComponent(
          'com.axellience.vuegwt.testsapp.client.components.basic.watch.prop.WatchPropParentTestComponent');
